...
namespace App\Services\Redsys\Lib\Constants;
...
class RESTConstants
{
    ...
    // Endpoints TEST
    public static $SANDBOX_JS              = "https://sis-t.redsys.es:25443/sis/NC/sandbox/redsysV2.js";
    ...
    //Endpoints INTE
    //public static $SANDBOX_JS = "https://sis-i.redsys.es:25443/sis/NC/inte/redsysV2.js";
    //public static $SANDBOX_ENDPOINT = "https://sis-i.redsys.es:25443/sis/rest/trataPeticionREST";
    //public static $SANDBOX_ENDPOINT_INICIA = "https://sis-i.redsys.es:25443/sis/rest/iniciaPeticionREST";


    public static $ENV_PRODUCTION             = "1";
    public static $PRODUCTION_JS              = "https://sis.redsys.es/sis/NC/redsysV2.js";
    ...
    public static $REQUEST_MERCHANT_EMV3DS_BROWSER_IP                  = "browserIP";
    ...
    public static $REQUEST_MERCHANT_EMV3DS_EMAIL                       = "email";
    ...
    public static function getEnviromentEndpoint($env, $operation)
    {
        if ($env == RESTConstants::$ENV_PRODUCTION) {
            ...
            return RESTConstants::$PRODUCTION_ENDPOINT;
        }

        if ($operation == RESTConstants::$INICIA) {
            return RESTConstants::$SANDBOX_ENDPOINT_INICIA;
        }
        return RESTConstants::$SANDBOX_ENDPOINT;
    }
}
